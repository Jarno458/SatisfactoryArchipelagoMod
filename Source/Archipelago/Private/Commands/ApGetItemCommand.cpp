...
AApGetItemCommand::AApGetItemCommand() {
	...
	Usage = FText::FromString(TEXT("/ap-getitem <item-name> - asks the server to send you the specified AP item, the request can be rejected by the server if you don't have permission")).ToString();
