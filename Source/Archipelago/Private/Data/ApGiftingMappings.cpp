...
const TMap<FString, FString> UApGiftingMappings::TraitParents = {
...
const TMap<FString, int64> UApGiftingMappings::TraitDefaultItemIds = {
...
const TMap<int64, TMap<FString, float>> UApGiftingMappings::TraitsPerItemRatings = {
