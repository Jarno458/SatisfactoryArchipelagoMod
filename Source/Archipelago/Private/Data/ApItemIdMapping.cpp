...
TMap<int64_t, FString> UApItemIdMapping::ItemIdToGameItemDescriptor = {
	//Parts
...
TMap<int64_t, FString> UApItemIdMapping::ItemIdToGameRecipe = {
...
TMap<int64_t, FString> UApItemIdMapping::ItemIdToGameBuilding = {
...
TMap<int64_t, FName> UApItemIdMapping::ItemIdToTrap = {
...
TMap<int64_t, FString> UApItemIdMapping::ItemIdToGameName2 = {
};
